...
async function seedDemo() {
  ...
  const companyValues = [
    { userId, name: 'Acme Corp', website: 'https://acme.example.com', industry: 'Technology' },
    { userId, name: 'BuildRight Inc', website: 'https://buildright.example.com', industry: 'Software' },
  ...
  const noteValues = [
    ...
    {
      userId,
      content: 'JD mentioned 5+ years React/Node. Emphasize full-stack projects.',
    ...
    {
      userId,
      content: 'Offer details: 120k base, 10% bonus, equity. Benefits start day 1.',
      typeTag: 'general',
      applicationId: appIds[2],
      interviewId: null,
      companyId: null,
